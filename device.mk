...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/configs/audio/audio_output_policy.conf:system/etc/audio_output_policy.conf \
    $(LOCAL_PATH)/configs/audio/audio_platform_info.xml:system/etc/audio_platform_info.xml \
    $(LOCAL_PATH)/configs/audio/audio_policy_configuration_aosp.xml:system/etc/audio_policy_configuration.xml \
...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/configs/msm_irqbalance_sdm630.conf:system/etc/msm_irqbalance_sdm630.conf
...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/rootdir/etc/init.qcom.post_boot.sh:system/bin/init.qcom.post_boot.sh
